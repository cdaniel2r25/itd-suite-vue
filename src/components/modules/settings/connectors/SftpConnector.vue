...
import TestPath from '@/components/modules/settings/connectors/TestPath.vue'
  ...
  methods: {
    async testConnector() {
      ...
      if (this.connector.server && this.connector.port) {
        this.connectorStatus = await this.testSftpConnector(this.connector)
    ...
    async createConnector() {
      this.connector.id = await this.createSftpConnector(this.connector)
    ...
    async saveConnector() {
      ...
      await this.saveSftpConnector(connectorToSend)
