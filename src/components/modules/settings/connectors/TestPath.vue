...
export default {
  ...
  methods: {
    async testPath(selectedPath) {
      ...
      if (this.connectorType === 'FTP')
        this.pathStatus = await this.testFtpPath(selectedPath)
      if (this.connectorType === 'SFTP')
        this.pathStatus = await this.testSftpPath(selectedPath)
    ...
    async createPath() {
      ...
      if (this.connectorType === 'SFTP')
        this.pathCreationResponse = await this.createSftpPath(this.selectedPath)
